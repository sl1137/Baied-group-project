import type { OutputCard as OutputCardType, Answer } from '../../types';
...
export default function OutputCard({ card, cardIndex, total, answer, onPick }: Props) {
  const { tr } = useLang();
  return (
    <>
      ...
      <div className={styles.cardBody} style={{ flex: 1 }}>
        <p className={styles.summaryText}>
          <strong>{tr.summaryLabel}</strong>{card.summary}
        </p>
